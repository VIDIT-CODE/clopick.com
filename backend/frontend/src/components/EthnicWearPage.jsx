...
const ethnic = [
  {
    id: 1,
    name: "Manyavar Men's Kurta Pajama Set",
    price: 1299,
    rating: 4.7,
    reviews: 140,
  ...
  {
    id: 2,
    name: "Sojanya Men's Nehru Jacket",
    price: 999,
    rating: 4.3,
    reviews: 80,
  ...
  {
    id: 3,
    name: "Vastramay Men's Pathani Suit",
    price: 1499,
    rating: 4.8,
    reviews: 170,
...
const EthnicWearPage = () => (
  <div style={{ background: "#f6f7fb", minHeight: "100vh", padding: 0, margin: 0, width: "100vw" }}>
    <div style={{
      ...
      <h1 style={{ fontSize: "2.5rem", fontWeight: 900, color: "#232526", marginBottom: 8 }}>Ethnic Wear</h1>
      <div style={{ fontSize: "1.2rem", color: "#555" }}>Traditional & festive ethnic wear. Bestsellers, new arrivals, and more!</div>
    </div>
    <div style={{
      display: "flex",
      gap: 24,
      ...
      <aside style={{
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <div>
            ...
            <input type="checkbox" id="p2" /> <label htmlFor="p2">₹1000 - ₹2000</label><br />
            <input type="checkbox" id="p3" /> <label htmlFor="p3">Above ₹2000</label>
          </div>
        </div>
        <div style={{ marginBottom: 12 }}>
        ...
        <div>
          ...
          <div>
            <input type="checkbox" id="type1" /> <label htmlFor="type1">Kurta</label><br />
            <input type="checkbox" id="type2" /> <label htmlFor="type2">Sherwani</label>
          </div>
        </div>
      </aside>
      <main style={{ flex: 1 }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ display: "flex", gap: 18, flexWrap: "wrap" }}>
            {ethnic.filter(e => e.bestseller).map(item => (
              <div key={item.id} style={{
                ...
                <div style={{ fontWeight: 700, fontSize: 17, color: "#232526" }}>{item.name}</div>
                <div style={{ color: "#1976d2", fontWeight: 700, fontSize: 16 }}>₹{item.price}</div>
                <div style={{ color: "#fbc02d", fontWeight: 600, fontSize: 15 }}>
                  {[...Array(Math.floor(item.rating))].map((_, i) => <FaStar key={i} />)}
                  <span style={{ color: "#888", fontWeight: 500, fontSize: 14 }}> ({item.reviews})</span>
                </div>
                <span style={{
                  position: "absolute",
                  top: 10,
        ...
        <div>
          <div style={{ fontWeight: 800, fontSize: 22, color: "#232526", marginBottom: 10 }}>All Ethnic Wear</div>
          <div style={{ display: "flex", gap: 18, flexWrap: "wrap" }}>
            {ethnic.map(item => (
              <div key={item.id} style={{
                background: "#fff",
